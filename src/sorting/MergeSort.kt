...
fun main(args: Array<String>) {
    ...
    mergeSort(array, 0, array.size) // sorting.merge sort function to sort the given array
...
fun mergeSort(input: Array<Int>, start: Int, end: Int) {
    ...
    merge(input, start, mid, end)  // sorting.merge the left and right side of the array making sure they are sorted
}
